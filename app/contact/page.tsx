                        ...
                        <div>
                            ...
                            <section className="lg:col-span-7"><div className="bg-surface-container-lowest p-8 md:p-16 rounded-xl border border-outline-variant/10 shadow-[0_20px_40px_rgba(0,12,30,0.04)] flex flex-col items-center text-center">
                                                                <div className="w-24 h-24 bg-[#25D366]/10 rounded-full flex items-center justify-center mb-8">
                                                                        <MdContactPhone className="w-12 h-12 text-[#25D366]" />
                                                                </div>
                                                                <h2 className="font-headline text-3xl md:text-4xl font-extrabold text-primary tracking-tight mb-4">Tap the icon below to get started</h2>
                                <p className="text-on-surface-variant text-lg leading-relaxed mb-10 max-w-md mx-auto">
                                    Send us a text or use WhatsApp, and our team will help you take the next step for your project. You can also call us directly if that is easier.
                                </p>
                                <div className="flex flex-col gap-4 sm:flex-row">
                                    ...
                                    <TrackableLink
                                        ...
                                        className="inline-flex items-center justify-center gap-3 rounded-lg bg-[#25D366] px-8 py-4 font-headline text-sm font-bold tracking-wide text-white transition-all hover:-translate-y-1 hover:shadow-2xl"
                                        action="whatsapp"
                                    >
