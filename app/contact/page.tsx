                        ...
                        <div>
                            ...
                            <header className="mb-16">
                                ...
                                <h1 className="mb-8 font-headline text-5xl font-extrabold leading-[1.1] tracking-tight text-tertiary md:text-7xl">
                                    Talk With an Atlanta Remodeling Contractor
                                </h1>
                                <p className="max-w-xl text-lg leading-relaxed text-on-surface-variant">
                                    Planning a kitchen remodel, bathroom renovation, flooring installation, or exterior repair? Share your project details and we will help you plan the next step.
                                </p>
                            </header>
                            ...
                            <section className="lg:col-span-7"><div className="bg-surface-container-lowest p-8 md:p-16 rounded-xl border border-outline-variant/10 shadow-[0_20px_40px_rgba(0,12,30,0.04)] flex flex-col items-center text-center">
                                ...
                                <h2 className="font-headline text-3xl md:text-4xl font-extrabold text-tertiary tracking-tight mb-4">Chat with us on WhatsApp</h2>
                                <p className="text-on-surface-variant text-lg leading-relaxed mb-10 max-w-md mx-auto">
                                    Get a fast response from our remodeling team and request a free estimate for your home project.
                                </p>
                                <TrackableLink
                        ...
                        <aside className="space-y-16 self-center">
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="flex items-start gap-6">
                                    ...
                                    <div>
                                        <h3 className="mb-2 font-headline text-xl font-bold text-tertiary">Business Hours</h3>
